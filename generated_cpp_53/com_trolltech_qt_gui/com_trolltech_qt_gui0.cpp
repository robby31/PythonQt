...
{
  return ( ((PythonQtPublicPromoter_QAbstractTableModel*)theWrappedObject)->promoted_flags(index));
}
...
QObject*  PythonQtWrapper_QAbstractTableModel::parent(QAbstractTableModel* theWrappedObject) const
{
